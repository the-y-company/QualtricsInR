...
id by listing all distributions available for the survey:

```{r}
list_distributions("SV_cScDRSV5hsN3YEd")
```
...
```{r}
create_reminder_distribution(
  "EMD_6yYmF6vopfUz4gn", # distribution id
...
```{r}
distribution_id <- generate_distribution_links("SV_cScDRSV5hsN3YEd", "ML_1ZlloFpR0AOl2GV", "Survey Respondents Generated Links")
print(distribution_id)
list_distribution_links(distribution_id, "SV_cScDRSV5hsN3YEd")
```