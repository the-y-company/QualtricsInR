...
create_erasure_request(c("john.doe@alabama.com", "maria.doe@alabama.coM"))
# Create a erasure request
create_erasure_request("john.doe@alabama.com", FALSE)
```
...
```
get_erasing_request("OP-1234-5678-9333")
```
