...
You must provide a list of customer emails to be deleted. We set the Qualtrics parameter
to `searh_only=TRUE` to default a dry run before deciding 
to erase the information associated to the email (`searh_only = FALSE`)
