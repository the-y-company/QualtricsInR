...
You can always set your credentials by calling the `set_qualtrics_opts()` function:
...
There are close to 200 different API calls provides by Qualtrics. You can find the progress of the implementation (including testing the calls) [here]("/articles/progress_table.html").

Depending on interest and demand from the community, efforts will be dedicated to the testing and implementation of missing references. Most of the XM 
